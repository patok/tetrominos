...
public class PlayFieldView extends View {
    ...
    private final int horizontalSize = PlayField.HORIZONTAL_SIZE;
    private final int verticalSize = PlayField.VERTICAL_SIZE;
    ...
    public void draw(Canvas canvas) {
        ...
        if ( blockSize == 0 ) {
            blockSize = Math.min(getWidth() / horizontalSize, getHeight() / verticalSize);
            FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(blockSize * PlayField.HORIZONTAL_SIZE,
